...
exports.bls12_381 = (0, bls_js_1.bls)({
    ...
    G1: {
        ...
        fromBytes: (bytes) => {
            ...
            if (value.length === 48 && compressed) {
                ...
                const right = Fp.add(Fp.pow(x, _3n), Fp.create(exports.bls12_381.params.G1b)); // yÂ² = xÂ³ + b
                let y = Fp.sqrt(right);
                if (!y)
    ...
    G2: {
        ...
        // https://eprint.iacr.org/2021/1130.pdf
        isTorsionFree: (c, P) => {
            return P.multiplyUnsafe(exports.bls12_381.params.x).negate().equals(G2psi(c, P)); // Ïˆ(P) == [u](P)
        ...
        Signature: {
            ...
            fromHex(hex) {
                ...
                const y2 = Fp2.add(Fp2.pow(x, _3n), exports.bls12_381.params.G2b); // yÂ² = xÂ³ + 4
                // The slow part
                let y = Fp2.sqrt(y2);
                if (!y)
