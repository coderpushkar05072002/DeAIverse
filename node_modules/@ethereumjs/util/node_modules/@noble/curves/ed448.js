...
function uvRatio(u, v) {
    ...
    const u2v = (0, modular_js_1.mod)(u * u * v, P); // uÂ²v
    const u3v = (0, modular_js_1.mod)(u2v * u, P); // uÂ³v
    const u5v3 = (0, modular_js_1.mod)(u3v * u2v * v, P); // uâµvÂ³
    const root = ed448_pow_Pminus3div4(u5v3);
    const x = (0, modular_js_1.mod)(u3v * root, P);
    // Verify that root is exists
    const x2 = (0, modular_js_1.mod)(x * x, P); // xÂ²
