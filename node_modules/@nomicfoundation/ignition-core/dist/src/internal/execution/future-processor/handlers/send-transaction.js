 ...
 */
async function sendTransaction(exState, executionStrategy, jsonRpcClient, nonceManager, transactionTrackingTimer, deploymentLoader) {
    ...
    const result = await (0, network_interaction_execution_1.sendTransactionForOnchainInteraction)(jsonRpcClient, exState.from, lastNetworkInteraction, nonceManager, (0, decode_simulation_result_1.decodeSimulationResult)(strategyGenerator, exState), deploymentLoader, exState.id);
