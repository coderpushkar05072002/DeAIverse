...
function uvRatio(u, v) {
    const P = ED25519_P;
    const v3 = (0, modular_ts_1.mod)(v * v * v, P); // vÂ³
    const v7 = (0, modular_ts_1.mod)(v3 * v3 * v, P); // vâ·
    // (p+3)/8 and (p-5)/8
    const pow = ed25519_pow_2_252_3(u * v7).pow_p_5_8;
    let x = (0, modular_ts_1.mod)(u * v3 * pow, P); // (uvÂ³)(uvâ·)^(p-5)/8
    const vx2 = (0, modular_ts_1.mod)(v * x * x, P); // vxÂ²
    ...
    const useRoot2 = vx2 === (0, modular_ts_1.mod)(-u, P); // If vxÂ² = -u, set x <-- x * 2^((p-1)/4)
    const noRoot = vx2 === (0, modular_ts_1.mod)(-u * ED25519_SQRT_M1, P); // There is no valid root, vxÂ² = -uâˆš(-1)
    if (useRoot1)
        x = root1;
    if (useRoot2 || noRoot)
